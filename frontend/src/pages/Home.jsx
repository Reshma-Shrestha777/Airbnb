  ...
  return (
    <div >
        ...
        {newlistData && newlistData.map((list)=>(
          <Card key={list._id} title={list.title} landmark={list.landMark} city={list.city} image1={list.image1} image2={list.image2} image3={list.image3} rent={list.rent} id={list._id} ratings={list.ratings}/>
        ))}
